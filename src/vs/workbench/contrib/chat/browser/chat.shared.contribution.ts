...
import { K2LanguageModelContribution } from './k2/k2.contribution.js';
...
registerWorkbenchContribution2(K2LanguageModelContribution.ID, K2LanguageModelContribution, WorkbenchPhase.BlockRestore);
